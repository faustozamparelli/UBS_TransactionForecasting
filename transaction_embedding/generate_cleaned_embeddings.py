...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Embed normalized descriptions while retaining every transaction and feature"
    )
    ...
    parser.add_argument(
        "--output-dir", type=Path, default=Path(__file__).parent / "artifacts" / "cleaned"
    )
    ...
    generate_embedding_artifacts(
        ...
        description_column="clean_description",
